...
# Tahoe plate3
uv run python benchmark/benchmark.py --class protplast --label cell_line --batch-size 1024 "$TAHOE_ROOT_DIR/plate3_filt_Vevo_Tahoe100M_WServicesFrom_ParseGigalab.h5ad"
